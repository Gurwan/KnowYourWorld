  ...
  render(){
    return(
      <div>
        ...
        <p>Total : {this.state.compteurTout}/{this.state.paysAfrique.length+this.state.paysAmerique.length+this.state.paysAsie.length+this.state.paysEuropeen.length+this.state.paysOceanie.length}</p>
